...
public class Quantidade_Notas {

    public static void main(String[] args) {
        Scanner leia = new Scanner(System.in);
        int n ;
                System.out.println("Calculadora de notas escolares");
        System.out.println("Por favor, insira o numero de notas a serem calculÃ§adas: ");
        n = leiaInt();
        float notas[] = new float[n+1];
        for (int i = 0; i < (n); i++) {
            do {
                System.out.print("Insira a " + (i + 1) + "Â° nota:");
                notas[i] = leiaFloat();
        ...
        notas[n] = notas[n] / 4;
        System.out.printf("A mÃ©dia do aluno Ã©: ", notas[4]);
        if (notas[n] >= 6) {
